                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header p-0 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="fw-bold py-3 mb-0">Members</h3>
                                <div class="d-flex py-2 project-tab flex-wrap w-sm-100">
                                    <button type="button" class="btn btn-dark w-sm-100" data-bs-toggle="modal" data-bs-target="#createproject"><i class="icofont-plus-circle me-2 fs-6"></i>Add Member</button>
                                </div>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            if (isset($members) and $members > 0) {
                                                while ($FarmersRow = mysqli_fetch_array($resultMembers)) {
                                                    $id = $FarmersRow['id'];
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title  fw-bold" id="editprojectLabel"> Edit Member</h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form action="includes/process.php" method="post">
                                                                        <input type="hidden" class="form-control" name="redirect" value="members.php">
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input class="form-control" type="password" name="password" name="*******" id="formFileMultipleone" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
