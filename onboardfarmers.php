                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="first_name" placeholder="Enter First Name">
                                                    </div>
                                                    <div class="form-group mb-4">
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="radio" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="do_you_have_children">Yes 
                                                        <input type="radio" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="do_you_have_children">No
                                                    </div>
                                                    <div class="form-group mb-4">
