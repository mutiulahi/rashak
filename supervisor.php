                                            ...
                                            ?>
                                                    ...
                                                    <div class="modal fade" id="editproject<?php echo $id ?>" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title  fw-bold" id="editprojectLabel"> Edit Supervisor</h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input class="form-control" type="password" name="password" id="formFileMultipleone" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
